...
sealed class TokenState {
    ...
    object LOGGEDIN : TokenState() {
        ...
        private fun createTokenRefreshTask(
            ...
            refreshTokenTask
                    .onComplete { notifyRefreshQueue(refreshQueue, it, null) }
                    .onFailure {
    ...
    /**
     * If not Access-Token is available, the user will be logged out. This state could also exist, if
